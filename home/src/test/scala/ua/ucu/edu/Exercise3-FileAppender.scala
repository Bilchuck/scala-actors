...
class FileAppenderActor { //TODO: First, we need to make sure this extends Actor
...
/**
  ...
  */
class FileAppenderActorSpec extends BaseAkkaSpec(ActorSystem("test-system")) {
  import FileAppenderActor._
  ...
  "Exercise3" should {
      ...
      "teach you how to use become and unbecome to change behavior" in {
        //TODO: Create a FileAppenderActor ActorRef
      ...
      "teach you how you can make IO asynchronous with Actors" in {
        ...
        //TODO: Create 2 EchoActor ActorRefs
